...
struct GeoResponse: Decodable {
    ...
    var locations: [Location] {
        return response.objectCollection.featureMember
            ...
            .map { Location(name: $0.geoObject.name, fullname: $0.geoObject.name, lan: Double($0.geoObject.point.pos.split(separator: " ")[1]) ?? 0, lon: Double($0.geoObject.point.pos.split(separator: " ")[0]) ?? 0) }
    }
}
